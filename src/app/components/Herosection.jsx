            ...
            <div className={styles.container}>
                <div className={styles.grid_two_section}>
                    <div className={heroStyles.hero_content}>
                        <h1>{title}</h1>
                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolorem recusandae perferendis ex odio alias expedita necessitatibus perspiciatis voluptatem iure aut?</p>
                        <Link href="/movie">
                            <button className={mulish.className}>Explore Movies</button>
                        </Link>
                    </div>
                    <div className={heroStyles.hero_image}>
                        <Image src={imageUrl} alt='watching netflix' width={500} height={400} />
                    </div>
                </div>
            </div>
            <div className={heroStyles['custom-shape-divider-bottom-1693459064']}>
